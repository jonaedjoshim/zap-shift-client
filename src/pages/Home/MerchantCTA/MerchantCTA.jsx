    ...
    return (
        <section className="px-4 py-12 md:py-20">
            <div className="max-w-7xl mx-auto">
                <div className="relative overflow-hidden rounded-[2.5rem] bg-[#002B2B] px-6 py-10 md:px-12 md:py-14 lg:px-16 flex flex-col md:flex-row items-center justify-between gap-10 min-h-100">

                    <div className="absolute top-0 left-1/3 w-150 h-75 bg-linear-to-b from-cyan-500/20 to-transparent blur-3xl pointer-events-none"></div>
