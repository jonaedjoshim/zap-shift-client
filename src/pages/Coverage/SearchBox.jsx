...
const SearchBox = ({ onSelect }) => {
  ...
  useEffect(() => {
    ...
    // Prioritize exact or startsWith matches first
    const sorted = result
      .map((r) => r.item)
      .sort((a, b) => {
    ...
    setSuggestions(sorted.slice(0, 5)); // max 5 suggestions
  }, [query]);
  ...
  return (
    <div className="flex flex-col max-w-md mb-12 relative" ref={wrapperRef}>
